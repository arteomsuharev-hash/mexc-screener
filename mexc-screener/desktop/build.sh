...
rm -rf resources/index.html resources/css resources/js/app.js resources/js/core-utils.js resources/js/terminal.js resources/js/widget-filter2.js resources/js/pattern-engine.js resources/js/vendor resources/assets
...
cp ../web/js/pattern-engine.js resources/js/pattern-engine.js
if [ -d ../web/js/vendor ]; then cp -r ../web/js/vendor resources/js/vendor; fi
